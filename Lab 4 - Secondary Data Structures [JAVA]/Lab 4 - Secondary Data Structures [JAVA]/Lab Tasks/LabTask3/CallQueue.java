...
class CallQueue {
    ...
    public void dequeueCall() {
        ...
        if (!vipQueue.isEmpty()) {
            int vipCustomerId = vipQueue.dequeue();
            System.out.println("Processing VIP Customer " + vipCustomerId + ".");
            return;
        } else if (!regularQueue.isEmpty()) {
            int regularCustomerId = regularQueue.dequeue();
            System.out.println("Processing Regular Customer " + regularCustomerId + ".");
        }
    }
